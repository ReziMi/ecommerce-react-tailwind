  ...
  return (
    <div className='bg-[#1E2832] bg-opacity-5 xl:px-28 px-4 py-16'>
      ...
      <div className='flex flex-wrap gap-4 items-center justify-center mb-20'>
        <Link to="#"><img src="/images/instagram/img1.png" alt="Instagram Image 1" /></Link>
        <Link to="#"><img src="/images/instagram/img2.png" alt="Instagram Image 2" /></Link>
        <Link to="#"><img src="/images/instagram/img3.png" alt="Instagram Image 3" /></Link>
        <Link to="#"><img src="/images/instagram/img4.png" alt="Instagram Image 4" /></Link>
        <Link to="#"><img src="/images/instagram/img5.png" alt="Instagram Image 5" /></Link>
        <Link to="#"><img src="/images/instagram/img6.png" alt="Instagram Image 6" /></Link>
      </div>
